...
KM_survival_plot <- function(sur_df, tit, xlab = TRUE, ylab = TRUE, strata = FALSE) {
...
pdf("./reviewer-addressing/plot/yesAmp-Fig3cd.pdf", width = 5, height = 5)
print(KM_survival_plot(sur_dfs[[1]], tit = "Complex", censor = FALSE))
print(KM_survival_plot(sur_dfs[[2]], tit = "NSMCE2", censor = FALSE))
dev.off()
print("done")
